...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            \includegraphics[width=7cm]{figures/LogoFaculteit.png}\\[0.5cm]
    ...
    % -------------------------------------------------------------------
    \bibliography{references.bib}  %  Patashnik, O. (1988), BibTEXing. Documentation for general BibTEX users.
